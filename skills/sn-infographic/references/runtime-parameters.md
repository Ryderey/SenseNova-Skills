...
- `4k` maps to a valid U1.5 canvas up to 4096 pixels on the long edge. If generation falls back to U1 Fast, the runtime maps it to the nearest supported Fast 2K bucket and records the actual model.
